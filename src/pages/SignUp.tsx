...
const SignUp = () => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    setLoading(false);
    if (error) {
      toast.error("Gagal sign up dengan Google: " + (error as Error).message);
    }
  };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Start your first AI internship simulation</p>
        </div>

        <div className="bg-card border border-border rounded-xl p-8 shadow-card">
          <Button variant="outline" className="w-full mb-6 h-11" onClick={handleGoogleSignUp} disabled={loading}>
