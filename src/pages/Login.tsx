    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to continue your simulation</p>
        </div>

        <div className="bg-card border border-border rounded-xl p-8 shadow-card">
          <Button variant="outline" className="w-full mb-6 h-11" onClick={() => navigate("/dashboard")}>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button variant="hero" className="w-full h-11" type="submit">Sign In</Button>
          </form>
        </div>
